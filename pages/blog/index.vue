    ...
    <div class="max-w-4xl mx-auto">
      ...
      <div class="text-center mb-16">
        ...
        <p class="text-xl text-gray-400 max-w-2xl mx-auto">
          Thoughts on web development, software engineering, and the latest in tech
        </p>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8" v-if="posts?.length">
        ...
        >
          <NuxtLink :to="article._path" class="block">
            ...
            <!-- Title -->
            <h2 class="text-xl font-semibold mb-3 group-hover:text-blue-400 transition-colors">
              {{ article.title }}
            </h2>
      ...
      <div v-else class="text-center py-16">
        ...
        <p class="text-gray-400 max-w-md mx-auto">
          I'm working on some great content. Check back soon for insights on web development and software engineering!
        </p>
      </div>
...
useHead({
  ...
  meta: [
    { name: 'description', content: 'Read about web development, software engineering, and the latest in tech from Nathan Collins.' }
  ]
})
